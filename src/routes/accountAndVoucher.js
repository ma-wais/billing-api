...
import {
    ...
    updateCashVoucher, deleteCashVoucher, getCashReport, getCashVoucher,
...
router.get('/cashvoucher/:id', getCashVoucher).put('/cashvoucher/:id', updateCashVoucher).delete('/cashvoucher/:id', deleteCashVoucher)
